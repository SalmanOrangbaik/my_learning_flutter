...
import 'package:my_learning/form/form_output_screen.dart';
import 'package:my_learning/helpers/size_helper.dart';
...
class _BelajarFormState extends State<BelajarForm> {
  ...
  void _submit() {
    ...
    if (!isValid) {
      ...
      Navigator.push(
        context, MaterialPageRoute(builder: (context) => OutputFormScreen(
